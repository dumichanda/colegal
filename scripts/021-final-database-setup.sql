-- This consolidated script combines previous setup scripts and
-- adds ON DELETE CASCADE to all foreign keys for proper relationships.
-- =====================================================
...
CREATE TABLE timeline_events (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    timeline_id UUID REFERENCES case_timelines(id) ON DELETE CASCADE,
    document_id UUID REFERENCES documents(id) ON DELETE CASCADE,
...
CREATE TABLE document_comparisons (
    ...
    comparison_document_id UUID REFERENCES documents(id) ON DELETE CASCADE,
